...
export const projects: Project[] = [
  ...
  {
    id: 43,
    title: "Big Sexxy Hot Sauce",
    year: "2026",
    role: "Designer & Engineer",
    description:
      "Bold, fiery brand site for Big Sexxy Hot Sauce. Next.js 15 with Framer Motion and fire-particle effects that make the heat feel alive.",
    image: "/projects/big-sexxy-sauce/hero.svg",
    link: "https://big-sexxy-sauce.vercel.app",
    liveUrl: "https://big-sexxy-sauce.vercel.app",
    repoUrl: "https://github.com/semajzandrews/big-sexxy-sauce",
    tags: ["Next.js 15", "Framer Motion", "Tailwind CSS"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["Next.js 15", "React", "Tailwind CSS", "Framer Motion"],
    features: [
      "Animated fire-particle hero",
      "Motion-driven product reveals",
      "Bold, high-contrast brand styling",
    ],
  ...
  {
    id: 44,
    title: "Medical Answering Services",
    year: "2026",
    role: "Designer & Engineer",
    description:
      "Production website for Medical Answering Services, a healthcare communications client. Built with Next.js 15 and Tailwind CSS, deployed on Vercel.",
    image: "/projects/medical-answering-services-website/hero.svg",
    link: "https://medical-answering-services-website.vercel.app",
    liveUrl: "https://medical-answering-services-website.vercel.app",
    repoUrl: "https://github.com/semajzandrews/medical-answering-services-website",
    tags: ["Next.js 15", "Tailwind CSS", "Vercel"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["Next.js 15", "React", "Tailwind CSS"],
    features: [
      "Healthcare-focused marketing site",
  ...
  {
    id: 45,
    title: "Medical Answering Services — Proposal",
    year: "2025",
    role: "Designer & Engineer",
    description:
      "Client proposal microsite that pitched the Medical Answering Services engagement, presenting scope, approach, and timeline as an interactive page.",
    image: "/projects/medical-answering-services-proposal/hero.svg",
    link: "https://medical-answering-services-proposal.vercel.app",
    liveUrl: "https://medical-answering-services-proposal.vercel.app",
    repoUrl: "https://github.com/semajzandrews/medical-answering-services-proposal",
    tags: ["Next.js", "Tailwind CSS", "Proposal"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["Next.js", "React", "Tailwind CSS"],
    features: [
      "Interactive scope and timeline presentation",
      "Clean, client-facing microsite",
    ],
    outcome: "Delivered as a live proposal microsite.",
  },

  {
    id: 46,
    title: "StationMD — Consulting Portfolio",
    year: "2025",
    role: "IT Consultant",
    description:
      "A portfolio of IT consulting work for StationMD telehealth: QR generation, PWA development, mobile apps, MySQL administration, and WCAG/VPAT accessibility compliance.",
    image: "/projects/stationmd-projects/hero.svg",
    link: "https://stationmd-projects.vercel.app",
    liveUrl: "https://stationmd-projects.vercel.app",
    repoUrl: "https://github.com/semajzandrews/stationmd-projects",
    tags: ["TypeScript", "PWA", "MySQL", "WCAG/VPAT"],
    categories: ["Web Development"],
    subcategory: "Full-Stack Development",
    technologies: ["TypeScript", "Next.js", "PWA", "MySQL"],
    features: [
      "QR code generation tooling",
      "Progressive web app development",
      "MySQL database administration",
      "WCAG and VPAT accessibility compliance",
    ],
    outcome: "Live engagement portfolio on Vercel.",
  },

  {
    id: 47,
    title: "StationMD — Email System",
    year: "2025",
    role: "Email Developer",
    description:
      "Hand-coded HTML email templates for StationMD, optimized to render consistently across all major email clients.",
    image: "/projects/stationmd-html-emails/hero.svg",
    link: "https://stationmd-html-emails.vercel.app",
    liveUrl: "https://stationmd-html-emails.vercel.app",
    repoUrl: "https://github.com/semajzandrews/stationmd-html-emails",
    tags: ["HTML Email", "Cross-Client", "Responsive"],
    categories: ["Email Development"],
    subcategory: "Transactional Emails",
    technologies: ["HTML", "CSS", "Cross-client testing"],
    features: [
      "Hand-coded, table-based templates",
      "Tested across all major email clients",
      "Responsive on mobile and desktop",
    ],
    outcome: "Deployed for StationMD communications.",
  },

  {
    id: 48,
    title: "Urban Outfitters — Promotional",
    year: "2025",
    role: "Email Developer",
    description:
      "Production HTML promotional email for Urban Outfitters. Hand-coded and cross-client tested for reliable rendering.",
    image: "/projects/urban-outfitters-promotional-email/hero.svg",
    link: "https://urban-outfitters-promotional-email.vercel.app",
    liveUrl: "https://urban-outfitters-promotional-email.vercel.app",
    repoUrl: "https://github.com/semajzandrews/urban-outfitters-promotional-email",
    tags: ["HTML Email", "Promotional", "Cross-Client"],
    categories: ["Email Development"],
    subcategory: "Promotional Emails",
    technologies: ["HTML", "CSS"],
    features: [
      "Hand-coded promotional layout",
      "Cross-client tested rendering",
    ],
    outcome: "Production-ready promotional template.",
  },

  {
    ...
    role: "Engineer",
    description:
      "Interview preparation tooling built in TypeScript to help candidates practice and structure their prep.",
    image: "/projects/intervue/hero.svg",
    link: "https://github.com/semajzandrews/intervue",
    repoUrl: "https://github.com/semajzandrews/intervue",
    tags: ["TypeScript", "Tooling"],
    categories: ["Web Development"],
    subcategory: "Full-Stack Development",
    technologies: ["TypeScript", "Node.js"],
    features: [
      "Structured interview preparation flow",
      "TypeScript codebase",
    ],
    outcome: "Open-source project on GitHub.",
  },

  {
    ...
    description:
      "A responsive real estate browsing experience for exploring property listings, built with HTML, CSS, and JavaScript.",
    image: "/projects/homescout-realestate/hero.svg",
    link: "https://github.com/semajzandrews/homescout-realestate",
    repoUrl: "https://github.com/semajzandrews/homescout-realestate",
    tags: ["HTML", "CSS", "JavaScript"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["HTML", "CSS", "JavaScript"],
    features: [
      "Responsive listing browser",
      "Clean property-focused UI",
    ],
    outcome: "Open-source project on GitHub.",
  },
  ...
  {
    id: 51,
    title: "3D Scroll Trigger",
    year: "2024",
    role: "Front-End Developer",
    description:
      "A 3D scroll-triggered animation demo exploring GSAP ScrollTrigger for depth and motion on scroll.",
    image: "/projects/3d-scroll-trigger/hero.svg",
    link: "https://github.com/semajzandrews/3d-scroll-trigger",
    repoUrl: "https://github.com/semajzandrews/3d-scroll-trigger",
    tags: ["GSAP", "ScrollTrigger", "JavaScript"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["GSAP", "JavaScript", "HTML", "CSS"],
    features: [
      "Scroll-driven 3D motion",
      "GSAP ScrollTrigger exploration",
    ],
    outcome: "Animation demo on GitHub.",
  },

  {
    ...
    role: "Front-End Developer",
    description:
      "An interactive landing page concept where visitors draw to reveal content, built with the canvas API and GSAP.",
    image: "/projects/draw-to-reveal-landing-page-website/hero.svg",
    link: "https://github.com/semajzandrews/draw-to-reveal-landing-page-website",
    repoUrl: "https://github.com/semajzandrews/draw-to-reveal-landing-page-website",
    tags: ["Canvas", "GSAP", "JavaScript"],
    categories: ["Web Development"],
    subcategory: "Front-End Development",
    technologies: ["Canvas API", "GSAP", "JavaScript"],
    features: [
      "Draw-to-reveal interaction",
      "Canvas and GSAP animation",
    ],
    outcome: "Interactive concept on GitHub.",
  },

  {
    id: 53,
    title: "CRM QC Reporting",
    year: "2026",
    role: "Engineer",
    description:
      "Python automation for CRM quality-control reporting, building data pipelines over HubSpot and Salesforce to surface QC metrics.",
    image: "/projects/crm_qc_reporting_project/hero.svg",
    link: "https://github.com/semajzandrews/crm_qc_reporting_project",
    repoUrl: "https://github.com/semajzandrews/crm_qc_reporting_project",
    tags: ["Python", "HubSpot", "Salesforce"],
    categories: ["Data & Automation"],
    subcategory: "Data Pipelines",
    technologies: ["Python", "Pandas", "HubSpot API", "Salesforce API"],
    features: [
      "Automated QC reporting pipelines",
